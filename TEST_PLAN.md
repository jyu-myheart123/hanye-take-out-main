...
| 序号 | 姓名 | 学号 | 角色 | 负责模块 |
| :--- | :--- | :--- | :--- | :--- |
| 1 | 陈越涛 | - | 组长/测试负责人 | 整体测试方案、性能测试、CI/CD、测试报告汇总 |
| 2 | 方海秋 | - | 自动化测试工程师 | JUnit5单元测试、Pytest接口自动化、契约测试 |
| 3 | 韩景尚 | - | 功能与安全测试工程师 | 黑盒功能测试、探索性测试、OWASP安全测试、缺陷管理 |
| 4 | 梁锦华 | - | UI与智能化测试工程师 | Selenium UI自动化、多终端兼容性测试、AI辅助测试 |
...
- 开展探索性测试
- 负责禅道缺陷全生命周期管理
- 执行OWASP安全测试与API安全专项测试

#### 梁锦华（UI与智能化测试工程师）
- 搭建Selenium4+POM UI自动化测试框架
- 编写Web端UI自动化测试用例
- 执行多终端兼容性测试
- 落地AI辅助测试应用并统计效率提升
...
| 姓名 | 职称 | 职责 |
| :--- | :--- | :--- |
| 肖振球 | 副教授 | 指导测试方案设计、审核测试报告、提供技术支持 |
